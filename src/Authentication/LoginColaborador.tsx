    ...
    return (
        ...
        <div className="main-container container-fluid">
          ...
          <Row className="no-gutter">
            {/* The image half */}
            <Col md={12} lg={6} xl={5} className="bg-image-container">
              <Row className="wd-120p mx-auto text-center">
                <img
                  src={login}
                  className="my-auto ht-xl-80p wd-md-120p wd-xl-80p mx-auto bg-image"
                  alt="logo"
                />
              </Row>
            </Col>
